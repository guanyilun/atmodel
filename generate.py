...
def add_radiance(graph, site_file, freq_range):
    None

# Add atmospheric transmission to plot
def add_trans(graph, site_file, freq_range):
    None

# Add galactic emission to plot
def add_galactic(graph, galactic_file, freq_range):
    None

# Add thermal mirror emission to plot
def add_mirror(graph, mirror_temp, mirror_file, freq_range):
    None

# Add zodiacal emission to plot
def add_zodiac(graph, zodiac_file, freq_range):
    None

# Add cosmic infrared background to plot
def add_cib(graph, freq_range):
    None

# Add cosmic microwave background to plot
def add_cmb(graph, freq_range):
    None

# Add signal to plot
def add_signal(graph, site_file, source_file, freq_range):
    None
...
def add_noise(graph, galactic_file, mirror_file, mirror_temp, zodiac_file, cib, cmb, freq_range):
    None
